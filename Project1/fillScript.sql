...
-- Agrega clientes
CALL AgregarCliente(205);
CALL AgregarCliente(258);

-- Agrega mecánicos
CALL AgregarMecanico("2008-12-10",500000,159,1,1);
CALL AgregarMecanico("2010-1-15",800000,789,1,2);
CALL AgregarMecanico("2016-2-20",700000,456,1,3);
CALL AgregarMecanico("2017-3-03",200000,741,1,4);
CALL AgregarMecanico("2015-4-22",900000,321,1,5);

CALL AgregarMecanico("2018-5-27",800000,987,2,6);
CALL AgregarMecanico("2015-6-29",500000,951,2,7);
CALL AgregarMecanico("2017-7-24",600000,333,2,8);
CALL AgregarMecanico("2014-8-15",600000,123,2,9);
CALL AgregarMecanico("2015-9-17",600000,147,2,10);


-- Agrega reparaciones
CALL AgregarReparacion(1, "Nacho chocó saliendo de la concesionaria");
CALL AgregarReparacion(2, "Pancho chocó saliendo de la universidad");
CALL AgregarReparacion(3, "Andrés chocó saliendo de la chicharronera");
CALL AgregarReparacion(4, "Crisptofer chocó saliendo de la casa");
CALL AgregarReparacion(5, "Raúl chocó saliendo de la universidad");
CALL AgregarReparacion(6, "Erick chocó saliendo de la chicharronera");
CALL AgregarReparacion(7, "Alejandra chocó saliendo de la concesionaria");
CALL AgregarReparacion(8, "Alejandro chocó saliendo de la casa");
CALL AgregarReparacion(9, "Iván chocó saliendo de la universidad");
CALL AgregarReparacion(10, "Celso chocó saliendo de la chicharronera");
CALL AgregarReparacion(11, "Teto chocó saliendo de la universidad");
CALL AgregarReparacion(12, "Pablito chocó un carrito");
CALL AgregarReparacion(13, "Pedro chocó saliendo de la universidad");
CALL AgregarReparacion(14, "Susana chocó saliendo de la casa");
CALL AgregarReparacion(15, "Ingrid chocó saliendo de la chicharronera");
CALL AgregarReparacion(16, "Adrián chocó saliendo de la casa");
CALL AgregarReparacion(17, "Mariana chocó saliendo de la concesionaria");
CALL AgregarReparacion(18, "Tiffany chocó saliendo de la casa");
CALL AgregarReparacion(19, "Cristina chocó saliendo de la chicharronera");
CALL AgregarReparacion(20, "Carolina chocó saliendo de la casa");
CALL AgregarReparacion(21, "Aymarú chocó saliendo de la concesionaria");
CALL AgregarReparacion(22, "Fernanda chocó saliendo de la chicharronera");
CALL AgregarReparacion(23, "Jhousen chocó saliendo de la casa");
CALL AgregarReparacion(24, "Jose chocó saliendo de la concesionaria");
CALL AgregarReparacion(25, "Bryan chocó saliendo de la casa");
CALL AgregarReparacion(26, "Chaco chocó saliendo de la concesionaria");
CALL AgregarReparacion(27, "Juan chocó saliendo de la universidad");
CALL AgregarReparacion(28, "Sebastián chocó saliendo de la chicharronera");
CALL AgregarReparacion(29, "Allan chocó saliendo de la casa");
CALL AgregarReparacion(30, "Pablo chocó saliendo de la universidad");
CALL AgregarReparacion(31, "Ángel chocó saliendo de la chicharronera");
CALL AgregarReparacion(32, "Daniel chocó saliendo de la concesionaria");
CALL AgregarReparacion(33, "Melissa chocó saliendo de la casa");
CALL AgregarReparacion(34, "Óscar chocó saliendo de la universidad");
CALL AgregarReparacion(35, "Kenneth chocó saliendo de la chicharronera");
CALL AgregarReparacion(36, "Karen chocó saliendo de la universidad");
CALL AgregarReparacion(37, "María chocó un carrito");
CALL AgregarReparacion(38, "Mauricio chocó saliendo de la universidad");
CALL AgregarReparacion(39, "Milton chocó saliendo de la casa");
CALL AgregarReparacion(40, "Jeff chocó saliendo de la chicharronera");
CALL AgregarReparacion(41, "Carlos chocó saliendo de la casa");
CALL AgregarReparacion(42, "Belinda chocó saliendo de la concesionaria");
CALL AgregarReparacion(43, "Gabriela chocó saliendo de la casa");
CALL AgregarReparacion(44, "Gregory chocó saliendo de la chicharronera");
CALL AgregarReparacion(45, "Jorman chocó saliendo de la casa");
CALL AgregarReparacion(46, "Saúl chocó saliendo de la concesionaria");
CALL AgregarReparacion(47, "Fernando chocó saliendo de la chicharronera");
CALL AgregarReparacion(48, "Érika chocó saliendo de la casa");
CALL AgregarReparacion(49, "Alexander chocó saliendo de la concesionaria");
CALL AgregarReparacion(50, "Chino chocó saliendo de la casa");
