...
CALL AgregarCoche(579390, 13, "gris", "usado", 22, 6000000, 1,NULL);
CALL AgregarCoche(707522, 16, "gris", "usado", 152, 2000000, 1,NULL);
CALL AgregarCoche(503249, 7, "amarillo", "usado", 224, 8000000, 1,NULL);
CALL AgregarCoche(631613, 13, "azul", "nuevo", 0, 9000000, 1,NULL);
CALL AgregarCoche(850940, 11, "café", "usado", 46, 1000000, 1,NULL);
CALL AgregarCoche(541747, 15, "azul", "nuevo", 0, 11000000, 1,NULL);
CALL AgregarCoche(268864, 6, "gris", "usado", 139, 14000000, 1,NULL);
CALL AgregarCoche(341232, 8, "negro", "usado", 192, 2000000, 1,NULL);
CALL AgregarCoche(970234, 19, "café", "nuevo", 0, 9000000, 1,NULL);
CALL AgregarCoche(861812, 19, "azul", "nuevo", 0, 13000000, 1,NULL);
CALL AgregarCoche(541749, 15, "azul", "nuevo", 0, 11000000, 1,NULL);
CALL AgregarCoche(268869, 6, "gris", "usado", 139, 14000000, 1,NULL);
CALL AgregarCoche(341239, 8, "negro", "usado", 192, 2000000, 1,NULL);
CALL AgregarCoche(970239, 19, "café", "nuevo", 0, 9000000, 1,NULL);
CALL AgregarCoche(861819, 19, "azul", "nuevo", 0, 13000000, 1,NULL);
-- Se venden 1
CALL AgregarCoche(361906, 7, "amarillo", "usado", 369, 54000000, 1,NULL);
CALL AgregarCoche(926391, 10, "amarillo", "usado", 172, 7800000, 1,NULL);
CALL AgregarCoche(528327, 9, "verde", "usado", 214, 2300000, 1,NULL);
CALL AgregarCoche(664913, 14, "amarillo", "usado", 326, 4500000, 1,NULL);
CALL AgregarCoche(868067, 5, "negro", "nuevo", 0, 9800000, 1,NULL);
CALL AgregarCoche(859814, 6, "café", "nuevo", 0, 4500000, 1,NULL);
CALL AgregarCoche(952273, 11, "morado", "usado", 355, 5600000, 1,NULL);
CALL AgregarCoche(905678, 8, "negro", "usado", 332, 2300000, 1,NULL);
CALL AgregarCoche(730815, 5, "azul", "usado", 354, 26500000, 1,NULL);
CALL AgregarCoche(334096, 16, "azul", "usado", 33, 4500000, 1,NULL);
CALL AgregarCoche(603761, 6, "verde", "nuevo", 0, 7600000, 1,NULL);
CALL AgregarCoche(355078, 11, "verde", "usado", 326, 8900000, 1,NULL);
CALL AgregarCoche(939852, 16, "morado", "nuevo", 0, 6700000, 1,NULL);
CALL AgregarCoche(137938, 4, "amarillo", "usado", 40, 4000000, 1,NULL);
CALL AgregarCoche(655257, 9, "negro", "usado", 238, 8700000, 1,NULL);
CALL AgregarCoche(277813, 4, "gris", "usado", 328, 5500000, 1,NULL);
CALL AgregarCoche(882766, 16, "azul", "nuevo", 0, 2300000, 1,NULL);
CALL AgregarCoche(395597, 13, "morado", "usado", 118, 4000000, 1,NULL);
CALL AgregarCoche(264861, 5, "café", "usado", 37, 2300000, 2,NULL);
CALL AgregarCoche(883736, 16, "negro", "nuevo", 0, 3200000, 1,NULL);
CALL AgregarCoche(708862, 14, "amarillo", "usado", 168, 4000000, 1,NULL);
CALL AgregarCoche(908781, 4, "café", "usado", 400, 4000000, 1,NULL);
CALL AgregarCoche(244835, 20, "amarillo", "nuevo", 0, 4000000, 1,NULL);
CALL AgregarCoche(834463, 1, "azul", "usado", 164, 4000000, 1,NULL);


-- Se agregan a Reparacion 2
CALL AgregarCoche(731898, 19, "gris", "usado", 300, 4000000, 2,NULL);
CALL AgregarCoche(140594, 7, "morado", "nuevo", 0, 6700000, 2,NULL);
CALL AgregarCoche(664449, 16, "morado", "usado", 69, 4000000, 2,NULL);
CALL AgregarCoche(586351, 4, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(894561, 3, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(586352, 4, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(894563, 3, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(334561, 3, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(236352, 4, "blanco", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(564563, 3, "blanco", "nuevo", 0, 4000000, 2,NULL);
-- Se venden 2
CALL AgregarCoche(596659, 7, "verde", "usado", 69, 6600000, 2,NULL);
CALL AgregarCoche(505354, 14, "gris", "usado", 195, 6700000, 2,NULL);
CALL AgregarCoche(507161, 4, "café", "usado", 331, 4000000, 2,NULL);
CALL AgregarCoche(489255, 11, "verde", "nuevo", 0, 9800000, 2,NULL);
CALL AgregarCoche(880017, 9, "gris", "usado", 377, 4900000, 2,NULL);
CALL AgregarCoche(880791, 3, "azul", "nuevo", 0, 6700000, 2,NULL);
CALL AgregarCoche(761194, 11, "amarillo", "nuevo", 0, 1100000, 2,NULL);
CALL AgregarCoche(270995, 8, "morado", "nuevo", 0, 4000000, 2,NULL);
CALL AgregarCoche(888193, 16, "blanco", "nuevo", 0, 2200000, 2,NULL);
CALL AgregarCoche(663976, 10, "café", "nuevo", 0, 9000000, 2,NULL);
CALL AgregarCoche(847236, 5, "blanco", "nuevo", 0, 3300000, 2,NULL);
