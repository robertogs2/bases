...
public class EmbeddedNeo4j {
    private static String nodePath = (System.getProperty("user.dir") + "/data/beings.csv").replaceAll("\\\\", "/");
    private static String relationPath = (System.getProperty("user.dir") + "/data/chain.csv").replaceAll("\\\\", "/");
    private static String cypherPath = (System.getProperty("user.dir") + "/data/importCSV.cypher").replaceAll("\\\\", "/");
