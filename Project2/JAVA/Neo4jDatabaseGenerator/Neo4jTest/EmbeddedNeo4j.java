...
public class EmbeddedNeo4j {
    private static String nodePath = (System.getProperty("user.dir") + "/data/Person.csv").replaceAll("\\\\", "/");
    private static String relationPath = (System.getProperty("user.dir") + "/data/Relationship.csv").replaceAll("\\\\", "/");
    private static String cypherPath = (System.getProperty("user.dir") + "/data/import_csv.cypher").replaceAll("\\\\", "/");
    private static String[] cmds;
    private static final File databaseDirectory = new File("databases/persons");
